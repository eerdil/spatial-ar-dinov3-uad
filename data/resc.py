...
class RESCTrainGoodDataset(Dataset):
    """
...
class RESCAnomalyDataset(Dataset):
    """
...
def get_train_loader(dataset_root,
    ...
    dataset = RESCTrainGoodDataset(img_dir=img_dir, transform=img_transform)
...
def get_anomaly_loader(dataset_root,
    ...
    dataset = RESCAnomalyDataset(root_dir=root_dir,
